...
```
git+ssh://git@github.com/deepcoder42/elastic-lib.git#egg=elastic-lib
```
...
```
cd {Python_Project}
git clone git@github.com:deepcoder42/elastic-lib.git
```
...
```
cd {Python_Project}
git clone --branch {Branch_Name} git@github.com:deepcoder42/elastic-lib.git
```
